    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="text" name="com_name" class="form-control" value="{{ $workhistory ? $workhistory->com_name : '' }}" placeholder="ByteCipher">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="date" name="work_duration_from" class="form-control" value="{{ $workhistory ? $workhistory->work_duration_from : '' }}" placeholder="From">
                <strong class="error" id="work_duration_from-error"></strong>
            </div>

            <div class="col-md-6">
                <label>To<span style="color:red">*</span></label>
                <input type="date" name="work_duration_to" class="form-control" value="{{ $workhistory ? $workhistory->work_duration_to : '' }}" placeholder="To">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="text" name="designation" class="form-control" value="{{ $workhistory ? $workhistory->designation : '' }}" placeholder="React Native Developer">
    ...
    <div class="form-group">
        ...
        <div class="upload-img-file">
            ...
            @if(!empty( $workhistory->offer_letter))
             <a href="{{ $workhistory->offer_letter ? $workhistory->offer_letter : '' }}" target="_blank" class="btn btn-primaryDoc">View Document</a>
           @endif
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="upload-img-file">
            ...
            @if(!empty($workhistory->exp_letter))
              <a href="{{ $workhistory->exp_letter ? $workhistory->exp_letter : '' }}" target="_blank" class="btn btn-primaryDoc">View Document</a>
           @endif
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="upload-img-file">
            ...
            @if(!empty( $workhistory->salary_slip))
              <a href="{{ $workhistory->salary_slip ? $workhistory->salary_slip : '' }}" target="_blank" class="btn btn-primaryDoc">View Document</a>
           @endif
        </div>
    </div>
