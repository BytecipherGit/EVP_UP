                  ...
                  {{-- <label>Document Type</label> --}}
                        ...
                        <div class="col-xl-5 col-lg-6 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" id="aadhar_card_id" name="aadhar_card_id"
                                    value="{{ $employee ? $employee->aadhar_card_id : '' }}" class="form-control"
                                    accept="image/jpeg,image/doc,image/pdf">
               ...
               @endif --}}
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-4 ">
                            <div class="form-group">
                                <label>&nbsp;</label>
                                @if (!empty($employee->aadhar_card_id))
                                    <a href="{{ $employee->aadhar_card_id ? $employee->aadhar_card_id : '#' }}"
                                        target="_blank" class="btn btn-primaryEmp"><i
                                            class="toggle-password fa fa-fw fa-eye"></i> View Document</a>
                                @endif
                            </div>
                ...
                <h5> Passport</h5>
                        ...
                        <div class="col-xl-5 col-lg-6 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="passport_number" class="form-control"
                                    value="{{ $employee ? $employee->passport_number : '' }}"
                        ...
                        <div class="col-xl-5 col-lg-6 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" id="passport_id" name="passport_id"
                                    value="{{ $employee ? $employee->passport_id : '' }}" class="form-control"
                                    accept="image/jpeg,image/doc,image/pdf">
