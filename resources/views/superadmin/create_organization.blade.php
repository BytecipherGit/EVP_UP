                    ...
                    <div class="row" id="registration">
                            ...
                            <div class="form-group">
                                <label for="country">Country <strong style="color:red">*</strong></label>
                                    <select id="country-dropdown" name="country" value="{{ old('country') }}"
                                        ...
                                        <option value="{{ $companyData ? $companyData->country : '' }}">Select Country</option>
                            ...
                            <div class="form-group">
                                <label for="state">State <strong style="color:red">*</strong></label>
                                    <div class="form-group mb-3">
                                        ...
                                        <option value="{{ $companyData ? $companyData->state : '' }}">Select State</option>     
                                        </select>
                            ...
                            <div class="form-group">
                                <label for="city">City <strong style="color:red">*</strong></label>
                                    <div class="form-group">
                                        ...
                                        <option value="{{ $companyData ? $companyData->city : '' }}">Select City</option>
                                        </select>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="address" name="address" value="{{ $companyData ? $companyData->address : '' }}" placeholder="Enter Your Address" rows="2" autofocus autocomplete="address" >{{ old('address') }}</textarea>
