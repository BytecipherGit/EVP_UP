...
<head>
    ...
    <style>
        ...
        .primary_color {
            background: <?php if (!empty(session('primary_color'))) {
        ...
        .secondary_color {
            color: <?php if (!empty(session('secondry_color'))) {
        ...
        .button_text_color {
            color: <?php if (!empty(session('button_text_color'))) {
                echo session('button_text_color');
            } else {
                echo '#5533ff';
            } ?> !important;
        }
        ...
        .button_background_color {
            background: <?php if (!empty(session('button_background_color'))) {
                echo session('button_background_color');
            } else {
                echo '#5533ff';
            } ?> !important;
        }
        ...
        .link_color {
            color: <?php if (!empty(session('link_color'))) {
                echo session('link_color');
            } else {
                echo '#5533ff';
            } ?> !important;
        }
        ...
        .ser-part .ser-box .head-sec .img-bg svg .iconstroke {
            stroke: <?php if (!empty(session('secondry_color'))) {
                echo session('secondry_color');
            } else {
                echo '#5533ff';
            } ?> !important;
        ...
        .setting-pages .nav-tabs .nav-item.show .nav-link img h2,
        .setting-pages .nav-tabs .nav-link.active h2 {
            color: <?php if (!empty(session('primary_color'))) {
                echo session('primary_color');
            } else {
                echo '#5533ff';
        ...
        .schudinter-tab .nav-tabs .nav-item.show .nav-linkSchedule,
        .nav-tabs .nav-linkSchedule.active {
            color: <?php if (!empty(session('button_text_color'))) {
                echo session('button_text_color');
            } else {
                echo '#5533ff';
        ...
        aside .active a {
            ...
            background: <?php if (!empty(session('secondry_color'))) {
                echo session('secondry_color');
            } else {
                echo '#5533ff';
            } ?> !important;
        ...
        .serch-main-box .nav-tabs .nav-item.show .nav-link,
        .serch-main-box .nav-tabs .nav-link.active {
            color: <?php if (!empty(session('primary_color'))) {
                echo session('primary_color');
            } else {
                echo '#5533ff';
            ...
            border-bottom: 2px solid <?php if (!empty(session('primary_color'))) {
                echo session('primary_color');
            } else {
                echo '#5533ff';
            } ?> !important;
        ...
        .pagination>.active>span:hover {
            ...
            border-color: <?php if (!empty(session('button_background_color'))) {
                echo session('button_background_color');
            } else {
                echo '#5533ff';
            } ?> !important;
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle-notification" href="#" id="navbarDropdownMenuLink"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                {{-- <img src="{{ asset('assets') }}/admin/images/notifications-icon.png"> --}}
                               <?xml version="1.0" encoding="UTF-8"?>
                                {{-- <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                                    viewBox="0 0 24 24" width="19" height="25">
                                    <path
                                    ...
                                    <path d="M7.1,20a5,5,0,0,0,9.8,0Z" fill="white" class="iconFill" />
                                </svg> --}}
                            ...
                            <div class="dropdown-menu dropdown-notifications" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <div class="all-noti-btn"><a href="/notification"
                                        class="button_background_color"><span class="button_text_color">See All
                                            Notifications</span></a></div>
                            </div>
                        </li>

                        <li class="nav-item dropdown">
                            <a class="nav-link profile-droup dropdown-toggle" href="#"
                            ...
                            <h5 class="mb-0">
                                <a role="button" data-toggle="collapse" href="#collapse-1" aria-expanded="true"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="9"
                                        ...
                                        <path
                                            d="M8.54692 9C8.23185 9.00055 7.91977 8.93882 7.62863 8.81837C7.33749 8.69792 7.07303 8.52112 6.85044 8.29813L0.5 1.94649L2.19649 0.25L8.54692 6.60044L14.8974 0.25L16.5938 1.94649L10.2434 8.29692C10.0209 8.52013 9.7565 8.69716 9.46535 8.81781C9.17421 8.93847 8.86208 9.00039 8.54692 9Z"
                                            fill="white" class="iconFill" />
                                    </svg>
                                </a>
                            </h5>
                ...
                <li @if (Request::segment(1) == 'invite_employee') class="active" @endif>
                    <a href="/invite_employee">
                        <svg xmlns="http://www.w3.org/2000/svg" width="147" height="181" viewBox="0 0 147 181"
                            fill="none">
                            <circle cx="82.5" cy="48.5" r="43.5" stroke="black" stroke-width="10"
                                class="iconstroke" />
                            <path
                                d="M63.5 108.5C48.1809 110.596 15.9807 118.465 5.93521 133.465C5.27888 134.445 5 135.618 5 136.798V175.5H63.5"
                                stroke="black" class="iconstroke" stroke-width="10" />
                            <line x1="116" y1="110" x2="116" y2="174" stroke="black"
                                class="iconstroke" stroke-width="10" />
                            <line x1="83" y1="143" x2="147" y2="143" stroke="black"
                                class="iconstroke" stroke-width="10" />
                        </svg>
                        Invite Employees
                    </a>
                ...
                <li @if (Request::segment(1) == 'schedule_interview') class="active" @endif>
                    <a href="/schedule_interview">
                        <svg xmlns="http://www.w3.org/2000/svg" width="180" height="192" viewBox="0 0 180 192"
                            fill="none">
                            <path
                                d="M67.4768 75.3138H58.0923C58.126 72.0848 58.4119 69.4443 58.95 67.3925C59.5219 65.3071 60.4469 63.4066 61.725 61.6912C63.0032 59.9758 64.7018 58.0249 66.8209 55.8385C68.3681 54.2576 69.7809 52.7777 71.059 51.3986C72.3708 49.9859 73.4304 48.4722 74.2376 46.8577C75.0449 45.2095 75.4485 43.2418 75.4485 40.9546C75.4485 38.6337 75.0281 36.6323 74.1872 34.9505C73.3799 33.2687 72.169 31.9737 70.5545 31.0656C68.9736 30.1574 67.0059 29.7033 64.6514 29.7033C62.7005 29.7033 60.8505 30.0565 59.1014 30.7628C57.3523 31.4692 55.9396 32.5624 54.8633 34.0424C53.7869 35.4887 53.2319 37.3892 53.1983 39.7437H43.8643C43.9315 35.9428 44.8734 32.6801 46.6897 29.9556C48.5397 27.2311 51.0288 25.1456 54.1569 23.6993C57.2851 22.2529 60.7832 21.5297 64.6514 21.5297C68.9231 21.5297 72.5558 22.3034 75.5494 23.8506C78.5767 25.3979 80.8808 27.6179 82.4617 30.5106C84.0426 33.3696 84.833 36.7669 84.833 40.7023C84.833 43.7295 84.2107 46.5213 82.9662 49.0777C81.7553 51.6004 80.1912 53.9717 78.274 56.1917C76.3567 58.4117 74.3217 60.5308 72.169 62.5489C70.319 64.2644 69.0745 66.1984 68.4354 68.3512C67.7963 70.5039 67.4768 72.8247 67.4768 75.3138ZM57.6887 91.3078C57.6887 89.7941 58.1596 88.516 59.1014 87.4733C60.0432 86.4305 61.4055 85.9092 63.1882 85.9092C65.0045 85.9092 66.3836 86.4305 67.3254 87.4733C68.2672 88.516 68.7381 89.7941 68.7381 91.3078C68.7381 92.7541 68.2672 93.9987 67.3254 95.0414C66.3836 96.0841 65.0045 96.6054 63.1882 96.6054C61.4055 96.6054 60.0432 96.0841 59.1014 95.0414C58.1596 93.9987 57.6887 92.7541 57.6887 91.3078Z"
                                fill="black" class="iconFill" />
                            <path
                                d="M5 105V76.5V10C5 8.89543 5.89543 8 7 8H123C124.105 8 125 8.89543 125 10V109.5C125 110.605 124.105 111.5 123 111.5H69.6776C69.2381 111.5 68.8109 111.645 68.4619 111.912L31.7156 140.039C30.3997 141.046 28.5 140.108 28.5 138.451V109C28.5 107.895 27.6046 107 26.5 107H7C5.89543 107 5 106.105 5 105Z"
                                stroke="black" class="iconstroke" stroke-width="10" />
                            <path
                                d="M124.5 54H173C174.105 54 175 54.8954 175 56V122.5V151C175 152.105 174.105 153 173 153H153.5C152.395 153 151.5 153.895 151.5 155V184.45C151.5 186.108 149.6 187.046 148.284 186.039L111.538 157.912C111.189 157.645 110.762 157.5 110.322 157.5H57C55.8954 157.5 55 156.605 55 155.5V120"
                                stroke="black" class="iconstroke" stroke-width="10" />
                        ...
                        <div class="card-header" id="heading-2">
                            <h5 class="mb-0">
                                <a role="button" data-toggle="collapse" href="#collapse-2" aria-expanded="true"
                                    ...
                                    Settings <svg xmlns="http://www.w3.org/2000/svg" width="17" height="9"
                                        viewBox="0 0 17 9" fill="none">
                                        <path
                                            d="M8.54692 9C8.23185 9.00055 7.91977 8.93882 7.62863 8.81837C7.33749 8.69792 7.07303 8.52112 6.85044 8.29813L0.5 1.94649L2.19649 0.25L8.54692 6.60044L14.8974 0.25L16.5938 1.94649L10.2434 8.29692C10.0209 8.52013 9.7565 8.69716 9.46535 8.81781C9.17421 8.93847 8.86208 9.00039 8.54692 9Z"
                                            fill="white" class="iconFill" />
                                    ...
                                    <ul>
                                            ...
                                            <a href="/exit_employee_process">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="180" height="181"
                                                    ...
                                                    <circle cx="82.5" cy="48.5" r="43.5"
                                                        stroke="black" stroke-width="10" class="iconstroke" />
                                                    <path
                                                        d="M63.5 108.5C48.1809 110.596 15.9807 118.465 5.93521 133.465C5.27888 134.445 5 135.618 5 136.798V175.5H63.5"stroke="black"
                                                        stroke-width="10" class="iconstroke" />
                                                    <path
                                                        d="M173.653 143.791C132.167 85.2593 85.9363 118.521 66.9371 143.732C66.3759 144.476 66.4564 145.524 67.0779 146.219C112.706 197.241 156.458 168.183 173.638 146.129C174.166 145.451 174.15 144.492 173.653 143.791Z"
                                                        stroke="black" stroke-width="10" class="iconstroke" />
                                                    <circle cx="120" cy="143" r="15"
                                        ...
                                        <li @if (Request::segment(1) == 'offer_send_details') class="active" @endif>
                                            <a href="/offer_send_details">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="147" height="181"
                                                    viewBox="0 0 147 181" fill="none">
                                                    <circle cx="82.5" cy="48.5" r="43.5"
                                                        stroke="black" stroke-width="10" class="iconstroke" />
                                                    <path
                                                        d="M63.5 108.5C48.1809 110.596 15.9807 118.465 5.93521 133.465C5.27888 134.445 5 135.618 5 136.798V175.5H63.5"
                                                        stroke="black" class="iconstroke" stroke-width="10" />
                                                    <line x1="116" y1="110" x2="116"
                                                        y2="174" stroke="black" class="iconstroke"
                                                        stroke-width="10" />
                                                    <line x1="83" y1="143" x2="147"
                                                        y2="143" stroke="black" class="iconstroke"
                                                        stroke-width="10" />
                                                </svg>
                                                Offer Send
                                            </a>
                                        ...
                                        <li @if (Request::segment(1) == 'qualified_email_template') class="active" @endif>
                                            <a href="/qualified_email_template">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="26"
                                                    ...
                                                    <path
                                                        d="M10.3978 14.7676C7.71269 15.2151 2.07403 16.6471 1 18.7952V24.8366H10.3978"
                                                        stroke="black" class="iconstroke" stroke-width="1.34254" />
                                                    <circle cx="13.0805" cy="6.04142" r="5.37015"
                                                        stroke="black" class="iconstroke" stroke-width="1.34254" />
                                                    <path
                                                        d="M15.1617 23.6753L15.1619 23.6751L22.0706 16.0942C22.0707 16.0942 22.0707 16.0942 22.0707 16.0942L22.0708 16.0941L15.1617 23.6753ZM15.1617 23.6753C15.1241 23.7168 15.0799 23.7491 15.0319 23.771C14.9839 23.7929 14.9329 23.804 14.8816 23.804C14.8303 23.804 14.7792 23.7929 14.7313 23.771C14.6833 23.7491 14.639 23.7168 14.6014 23.6753L14.6013 23.6752L11.9296 20.7406L15.1617 23.6753Z"
                                                        fill="black" stroke="black" class="iconstroke iconFill"
                                                        stroke-width="0.9" />
                                                </svg>
                                                For Qualified
                                            </a>
                                            ...
                                            <a href="/not_qualified_template">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="26"
                                                    ...
                                                    <circle cx="13.0805" cy="6.04142" r="5.37015"
                                                        stroke="black" class="iconstroke" stroke-width="1.34254" />
                                                    <path
                                                        d="M21.8372 17.1628C21.7329 17.0586 21.5914 17 21.4439 17C21.2964 17 21.155 17.0586 21.0507 17.1628L18.5 19.7135L15.9493 17.1628C15.845 17.0586 15.7036 17 15.5561 17C15.4086 17 15.2671 17.0586 15.1628 17.1628C15.0586 17.2671 15 17.4086 15 17.5561C15 17.7036 15.0586 17.845 15.1628 17.9493L17.7135 20.5L15.1628 23.0507C15.0586 23.155 15 23.2964 15 23.4439C15 23.5914 15.0586 23.7329 15.1628 23.8372C15.2671 23.9414 15.4086 24 15.5561 24C15.7036 24 15.845 23.9414 15.9493 23.8372L18.5 21.2865L21.0507 23.8372C21.155 23.9414 21.2964 24 21.4439 24C21.5914 24 21.7329 23.9414 21.8372 23.8372C21.9414 23.7329 22 23.5914 22 23.4439C22 23.2964 21.9414 23.155 21.8372 23.0507L19.2865 20.5L21.8372 17.9493C21.9414 17.845 22 17.7036 22 17.5561C22 17.4086 21.9414 17.2671 21.8372 17.1628Z"
                                                        fill="black" class="iconFill" />
                                                </svg>
                                                For Not Qualified
                                            </a>
