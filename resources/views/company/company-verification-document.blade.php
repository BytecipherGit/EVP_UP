...
<script type="text/javascript">
    ...
    $("#dynamic-ar").click(function () {
        ...
        $("#dynamicAddRemove").append('<tr><td><input type="text" name="addMoreInputFields[' + i +
            '][rid]" class="form-control" placeholder="Enter your number"></td><td><input type="text" name="addMoreInputFields[' + i +
    ...
    <script>
      $('.extra-fields-customer').click(function() {
        ...
        $('.single').append('<a href="#" class="remove-field btn-remove-customer add-plus minus-icon"><span><img src="assets/company/images/minus-icon.png"></span></a>');
