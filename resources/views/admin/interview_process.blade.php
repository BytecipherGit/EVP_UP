        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="main-right-button-box">
                    <a style="text-decoration:none" href="#" id="createProcess" class="mr-2 button_background_color"><img src="{{ asset('assets') }}/admin/images/button-plus.png">Interview Process</a>
        ...
        <form id="interview_process_form" method="post" autocomplete="off" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn-secondary-cust" data-dismiss="modal">Cancel</button>
                    <button type="submit" id="interviewProcessSubmit" class="btn-primary-cust primary_color">Submit</button>
                </div>
            </div>
        </form>
    </div>
