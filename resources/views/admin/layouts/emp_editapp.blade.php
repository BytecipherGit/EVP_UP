...
@section('title','EVP - Onboarding-Employee')
    ...
    <div class="main-container">
        ...
        <div class="employee-tab-bar"> 
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="/edit_identity" role="tab">Identity</a>
          </li>
      
          <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="/edit_qualification" role="tab">Qualification</a>
          </li>          
          <li class="nav-item">
