...
<input type="hidden" id="interview_id" name="interview_id" value="{{ $interview->id ? $interview->id : '' }}" />
<div class="form-group">
    ...
    <input type="type" name="title" class="form-control" placeholder="Round 1"
        value="{{ $interview->title ? $interview->title : '' }}">
...
<div class="form-group">
    ...
    <input type="type" name="descriptions" class="form-control" placeholder="Interview Scheduled"
        value="{{ $interview->descriptions ? $interview->descriptions : '' }}">
