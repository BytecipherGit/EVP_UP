    ...
    <section style="max-width: 680px; margin:20px auto; background:#f2f2f3; display:block; border-radius: 10px;"> 
        ...
        <br>
            <footer style="padding:20px;">
                <p style="font-weight:300;font-size: 16px; line-height: 32px; color: #373E57; font-family: 'DM Sans', sans-serif; margin: 0;">Copyright {{date('Y')}} <span style="color: #5533FF;">ByteCipher</span>. All Right Reserved.</p>
