                    ...
                    <div
                        ...
                        <h6
                            ...
                            <img src="{{ asset('assets') }}/admin/candidate/images/phone-call.png"
                                style="width: 24px; margin-right: 10px;"> {{ $mailData['phone'] }}</h6>
                        <h6
                            ...
                            <img src="{{ asset('assets') }}/admin/candidate/images/calendar-icon.png"
                                style="width: 24px; margin-right: 10px;"> On dated {{ $mailData['meeting_date'] }} and <br> start time {{ $mailData['meeting_start_time'] }} - end time {{ $mailData['meeting_end_time'] }}</h6>
