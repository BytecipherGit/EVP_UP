              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="upload-img-file">
                      <div class="circle">
                        <img class="profile-pic" id="profile-pic4" name="document" @if ($qualification->document!== Null) value="/image/{{ old('document', $qualification->document) }}" src="/image/{{ $qualification->document }}" @else src="{{ asset('assets') }}/admin/images/file-icon-img.png" @endif/>
                      </div>
                      <p>You can drag or drop <span>png. jpeg</span> </p>
                      <div class="p-image ml-auto">
