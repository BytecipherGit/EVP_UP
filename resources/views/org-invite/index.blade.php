...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets') }}/css/main-container.css">
    ...
    <div class="container-fluid">
      <div class="align-self-center pad-0 form-section">
        <div class="cover-box-txt"> 
          ...
          <a href="#" class="btn-secondary-cust">Cancel</a><a href="basic-info.html" class="btn-primary-cust">Confirm</a>
